...
export default function renderQuests(root){
  ...
  const scaleRecentCrowns=(mult=4)=>{ try{ [...document.querySelectorAll('.crown')].slice(-20).forEach(n=>n.style.fontSize=(36*mult)+'px'); }catch(e){} };
  ...
  root.innerHTML = `
    ...
    <section class="grid two">
      ...
      <div class="panel">
        ...
        <div class="row"><span>Progress</span><div class="bar" style="flex:1"><div id="raidProg" style="height:10px;background:linear-gradient(90deg,#fc7,#ff7)"></div></div></div>
