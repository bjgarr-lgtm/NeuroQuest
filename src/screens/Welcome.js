  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={{ padding:16, paddingBottom:32 }}>
      ...
      <View style={styles.heroCard}>
        {/* use your existing splash art; swap to another asset if you prefer */}
        <Image source={require('../../assets/splash.png')} style={styles.heroImg} resizeMode="contain" />
      </View>
...
const styles = StyleSheet.create({
  ...
  heroCard:{ backgroundColor:'#131024', borderWidth:2, borderColor:'#2d2450', borderRadius:14, padding:12, marginBottom:14 },
  heroImg:{ width:'100%', height:240 },
  rules:{ backgroundColor:'#131024', borderWidth:2, borderColor:'#2d2450', borderRadius:14, padding:14, marginBottom:16 },
